...
import { IonButton, IonLabel, IonItem, IonThumbnail,IonListHeader, IonList, IonText, IonContent, IonHeader, IonToolbar, IonTitle, IonButtons } from "@ionic/angular/standalone";


@Component({
  selector: 'app-mis-libros',
  standalone: true,
  imports: [IonButtons, IonTitle, IonToolbar,IonThumbnail ,IonHeader, IonContent, IonText, IonList, IonListHeader, IonItem, IonLabel, IonButton, CommonModule, RouterModule, FormsModule],
